...
// -------------------------------------------------------------------------- //
TEST_F(FixtureCommand, t1_data_subscription_server) {
    ...
    token_test<mzn::T1DataSubscriptionServer>(msg);
}
...
// -------------------------------------------------------------------------- //
TEST_F(FixtureCommand, t1_logical_channel_queue) {

    std::vector<uint8_t> msg = {
              0x20, 0x30, 0x30, 0x42, 0x48, 0x5a, 0x00,
        0xe0, 0x03, 0x40, 0x00, 0x13, 0x3e, 0x00, 0x28,
        0x00, 0x03, 0x3f, 0x00, 0x00, 0x00, 0x00, 0x3c,
        0x00, 0x00, 0x5d, 0xc0, 0x0d, 0x00, 0x05, 0x00,
        0x0b,
    };

    token_test<mzn::T1LogicalChannelQueue>(msg);
}


// -------------------------------------------------------------------------- //
TEST_F(FixtureCommand, t1_control_detector_specification) {

    std::vector<uint8_t> msg = {
              0x15, 0x02, 0x01, 0x06, 0x4c, 0x48, 0x5a,
        0x44, 0x45, 0x54, 0xc0, 0x41, 0xc4, 0x00, 0xc4,
        0x04, 0xc1, 0xc3, 0xc2, 0x0b, 0xff,
    };

    token_test<mzn::T1ControlDetectorSpecification>(msg);
}
...
TEST_F(FixtureCommand, t2_tokens) {
    ...
    std::vector<uint8_t> msg = {
        ...
        // logical_channel_queue
        ,
    };
