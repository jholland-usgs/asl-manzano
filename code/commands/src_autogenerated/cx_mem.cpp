...
uint16_t CxMem::msg_to_data(std::vector<uint8_t> const & msg,
                            uint16_t mf_begin) {
...
uint16_t CxMem::data_to_msg(std::vector<uint8_t> & msg,
...
std::ostream & CxMem::os_print(std::ostream & cmd_os) const {
    cmd_os << "\n --- CX_MEM ---  \n";
